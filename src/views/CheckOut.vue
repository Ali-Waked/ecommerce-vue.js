  ...
  <div class="check-out">
    <v-container fluid class="pa-0 ma-0">
      <v-row class="flex-column-reverse flex-lg-row">
        <v-col cols="12" md="9" lg="7" class="pb-0 mx-auto">
          <v-card
            color="white"
            elevation="0"
            style="padding: 60px 40px 0px 120px"
            class="w-100 right-card"
          >
            ...
            <v-card-actions class="align-center justify-space-between mb-7">
              <v-btn
                color="#3F51B5"
                variant="elevated"
                class="flex-grow-1"
            ...
            <v-divider lenght="100%" color="black"></v-divider>
            <v-card-text style="font-size: 10px; color: #999999"
              >All Rights Reserved new-ella-demo</v-card-text
            >
          </v-card>
        </v-col>
        <v-col cols="12" md="9" lg="5" class="pb-0 mx-auto">
          <v-card
            elevation="0"
          ...
          >
            <v-card
              ...
              width="100%"
              color="transparent"
              class="d-flex align-center justify-space-between mb-3 overflow-visible"
            >
              <v-badge :content="item.quantity" color="grey-darken-1">
                <img
                  ...
                  width="50"
                  height="50"
                  style="border-radius: 7px; border: 1px solid #484848"
                />
              </v-badge>
              ...
              <v-card-text
                ...
                style="font-size: 12px; color: #4b3a3a"
                >${{
                  Math.ceil(
