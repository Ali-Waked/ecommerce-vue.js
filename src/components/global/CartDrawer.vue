  ...
  <div class="drawer">
    ...
    >
      <v-card elevation="0" class="px-0">
        ...
        >
        <v-card-text class="px-0 py-0" style="color: #444"
          >{{ cartItems.length }} Items</v-card-text
        >
        <v-card-text class="px-0" style="color: #444" v-if="!cartItems.length"
          >Free shipping for all orders over $10000.0</v-card-text
        >
        <v-card-text
        ...
        <v-container class="px-0">
          <v-row v-for="item in cartItems" :key="item.id" class="align-center">
            ...
            <v-col cols="7">
              ...
              >
              <div class="item-footer d-flex justify-space-around align-center">
                <div
                  class="counter px-1"
                  style="
                    border-radius: 30px;
      ...
      <v-card class="mt-5 px-0" elevation="0" v-if="cartItems.length">
        <v-card-actions
