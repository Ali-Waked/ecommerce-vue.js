<template>
  <div class="quality-features py-13 bg-grey-lighten-3">
    <v-container fluid>
      <v-row>
        <v-col cols="" v-for="card in cards" :key="card.title" class="px-2">
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              v-bind="props"
              :elevation="isHovering ? 2 : 0"
              class="text-center d-flex align-center justify-center cursor-pointer"
              height="300"
              :color="isHovering ? '#02218f26' : 'white'"
            >
              <div class="parent">
